// ============================================================
// Salesforce Certified User Experience (UX) Designer Simulator — Master Logic
// Hardcoded 210-Question Static Data Repository & Blueprint Engine
...
const state = {
  questions: [],          // Static questions array
  activeTab: 0,
...
// ============================================================
// SECTION 2: HARDCODED STATIC QUESTIONS MATRIX (EXACTLY 210 ITEMS)
// ============================================================
...
const QUESTIONS = [
  ...
  },
  {
    ...
    "correctAnswerText": "4.5:1",
    "explanation": "WCAG 2.1 AA requires a contrast ratio of at least 4.5:1 for normal body text and 3:1 for large text (18pt or 14pt bold)."
  },
  {
    "id": 11,
    "category": "Salesforce Lightning Design System (SLDS)",
    "question": "Which SLDS component class should a designer use to wrap page content in a standardized white container with borders and header padding?",
    "choices": [
      "slds-box",
      "slds-card",
      "slds-panel",
    ...
    "correctAnswerText": "slds-card",
    "explanation": "In SLDS, slds-card provides a structured container with white background, subtle border, header title, and action buttons for record details or lists."
  },
  {
    "id": 12,
    "category": "UX Fundamentals",
  ...
  },
  {
    ...
    "question": "Which design methodology focuses on understanding user needs through empathy maps, user interviews, iterative prototyping, and continuous user testing?",
    "choices": [
    ...
    "correctAnswerText": "Human-Centered Design (HCD)",
    "explanation": "Human-Centered Design (HCD) is an iterative framework that places user needs, behaviors, and pain points at the center of solution development."
  },
  {
    "id": 20,
    "category": "Discovery",
    "question": "During the discovery phase, a UX Designer wants to observe service representatives handling live customer support cases in their actual work environment. Which research method is best suited for this goal?",
    "choices": [
      "Contextual Inquiry",
      "A/B Testing",
      "Card Sorting",
    ...
    "correctAnswerText": "Contextual Inquiry",
    "explanation": "Contextual inquiry combines observation and interview in the user's natural environment to uncover real workflows, workarounds, and environmental constraints."
  },
  {
    "id": 21,
    "category": "UX Fundamentals",
  ...
  },
  {
    "id": 56,
    "category": "Declarative Design",
    "question": "A UX Designer needs to display dynamic field guidance to users based on specified record values without writing custom code. Which declarative Salesforce feature should be used?",
    "choices": [
      "In-App Guidance",
      "Dynamic Forms",
    ...
    "correctAnswerText": "Dynamic Forms",
    "explanation": "Dynamic Forms allows administrators and designers to configure record fields and sections directly in Lightning App Builder with visibility rules based on record data."
  },
  {
    "id": 57,
    "category": "Declarative Design",
    "question": "Which two declarative tools allow a UX Designer to guide service agents step-by-step through complex data entry processes? (Choose 2 answers)",
    "choices": [
      "Screen Flows",
      "Quick Actions",
      "Apex Triggers",
    ...
    "explanation": "Screen Flows provide step-by-step wizard interfaces, while Quick Actions give immediate access to concise record creation/update modals."
  },
  {
    "id": 58,
    "category": "Declarative Design",
  ...
  },
  {
    "id": 61,
    "category": "Testing",
    "question": "Which usability testing method asks users to categorize items into named groups to inform navigation structure and information architecture?",
    "choices": [
      "Card Sorting",
      "A/B Testing",
      "Diary Study",
    ...
    "correctAnswerText": "Card Sorting",
    "explanation": "Card sorting is a UX research technique where users organize topics into categories to design intuitive site maps and navigation structures."
  },
  {
    "id": 62,
    "category": "Testing",
    "question": "A UX team wants to evaluate whether a new portal navigation layout helps users find support documentation faster than the current design. Which quantitative testing method should be conducted?",
    "choices": [
      "A/B Testing",
      "Focus Group",
    ...
    "correctAnswerText": "A/B Testing",
    "explanation": "A/B testing compares two versions of a webpage or UI component with live users to measure performance metrics like completion speed or task success."
  },
  {
    "id": 63,
    "category": "Salesforce Lightning Design System (SLDS)",
    "question": "What are design tokens in the Salesforce Lightning Design System (SLDS)?",
    "choices": [
      "Named visual design attributes such as colors, font sizes, and spacing values used in place of hardcoded CSS",
      "Component templates written in HTML",
      "Apex classes that format JSON data",
      "SVG icons used in navigation bars"
    ],
    "correctAnswerText": "Named visual design attributes such as colors, font sizes, and spacing values used in place of hardcoded CSS",
    "explanation": "Design tokens are named entities that store visual attributes like color hex codes or pixel spacing, maintaining design consistency across platforms."
  },
  {
    "id": 64,
    "category": "Testing",
  ...
  },
  {
    ...
    "correctAnswerText": "slds-text-align_right",
    "explanation": "In SLDS, utility classes for text alignment follow the format slds-text-align_right, slds-text-align_center, and slds-text-align_left."
  },
  {
    "id": 66,
    "category": "Discovery",
    "question": "Which artifact created during discovery synthesizes user goals, pain points, technical proficiency, and typical daily workflows into a representative user model?",
    "choices": [
      "User Persona",
    ...
    "correctAnswerText": "User Persona",
    "explanation": "User Personas are semi-fictional representations of target users based on user research, helping design teams maintain user empathy and align features with actual needs."
  },
  {
    "id": 67,
    "category": "Salesforce Lightning Design System (SLDS)",
  ...
  },
  {
    "id": 92,
    "category": "UX Fundamentals",
    "question": "When designing for screen readers, which HTML attribute provides accessible descriptive names to interactive elements that lack visible text labels?",
    "choices": [
      "aria-label",
      "title-tag",
      "alt-label",
    ...
    "correctAnswerText": "aria-label",
    "explanation": "The aria-label attribute provides a string label for screen readers when an interactive element (like an icon button) has no visible text label."
  },
  {
    "id": 93,
    "category": "UX Fundamentals",
    "question": "Which mobile design principle recommends positioning primary call-to-action buttons within natural thumb reach on smartphone screens?",
    "choices": [
    ...
    "correctAnswerText": "Thumb Zone Optimization",
    "explanation": "Thumb Zone Optimization places key interactive controls in comfortable, easily reachable screen areas for one-handed mobile device usage."
  },
  {
    "id": 94,
    "category": "UX Fundamentals",
  ...
  },
  {
    ...
    "explanation": "Highlights Panel displays key fields at the top of a record page, and Path shows stage progress and key guidance for reps."
  },
  {
    "id": 100,
    "category": "Declarative Design",
    "question": "Which feature in Lightning App Builder allows a designer to control component visibility based on the user's profile, record field values, or device form factor?",
    "choices": [
    ...
    "correctAnswerText": "Component Visibility Rules",
    "explanation": "Set component visibility rules in Lightning App Builder to show or hide components dynamically depending on record values, user profiles, or client device."
  },
  {
    "id": 101,
    "category": "Declarative Design",
  ...
  },
  {
    "id": 114,
    "category": "Human-Centered Design",
    "question": "Which principle of Inclusive Design emphasizes providing multiple ways for users to interact with content, accommodating permanent, temporary, or situational disabilities?",
    "choices": [
    ...
    "correctAnswerText": "Offer Comparable Experiences",
    "explanation": "Inclusive Design ensures that users with different abilities (whether permanent like blindness, or situational like bright sunlight) experience equivalent utility and dignity."
  },
  {
    "id": 115,
    "category": "Human-Centered Design",
    "question": "A UX Designer is conducting user research with users who rely on assistive technologies. Which practice ensures inclusive participation?",
    "choices": [
      "Testing with screen readers, keyboard-only navigation, and accessible testing tools",
      "Excluding screen reader users from early prototypes",
      "Relying exclusively on automated accessibility scanners",
      "Designing only for high-resolution desktop screens"
    ],
    "correctAnswerText": "Testing with screen readers, keyboard-only navigation, and accessible testing tools",
    "explanation": "Including users with assistive technologies in research and testing ensures authentic evaluation of accessibility and usability."
  },
  {
    "id": 116,
    "category": "Salesforce Lightning Design System (SLDS)",
  ...
  },
  {
    "id": 119,
    "category": "Testing",
    "question": "Which heuristic in Jakob Nielsen's 10 Usability Heuristics states that system status should always keep users informed about what is happening through appropriate feedback within reasonable time?",
    "choices": [
    ...
    "explanation": "Visibility of System Status ensures users receive clear, timely feedback (such as spinners, progress bars, or success messages) about ongoing system actions."
  },
  {
    "id": 120,
    "category": "Testing",
    "question": "During user testing, a participant experiences difficulty locating the 'Save' button because it blends into the background color. Which design issue does this reveal?",
    "choices": [
      "Inadequate Visual Hierarchy and Contrast",
      "Database Connection Latency",
      "Missing Custom Object",
      "Incorrect Apex Logic"
    ],
    "correctAnswerText": "Inadequate Visual Hierarchy and Contrast",
    "explanation": "When primary actions blend into background elements, it indicates insufficient visual contrast and hierarchy, reducing discoverability."
  },
  {
    "id": 121,
    "category": "UX Fundamentals",
  ...
  },
  {
    "id": 139,
    "category": "Declarative Design",
    "question": "A UX Designer wants to customize the navigation bar for a specialized sales team in Lightning Experience. Which two configurations can be managed natively in Navigation Bar setup? (Choose 2 answers)",
    "choices": [
      "Order of standard and custom object tabs",
      "Default theme brand color",
      "Custom Lightning Page tabs",
    ...
    "explanation": "Administrators and designers can reorder navigation items and add custom Lightning Pages or standard object tabs directly in App Manager Navigation Bar configuration."
  },
  {
    "id": 140,
    "category": "Salesforce Lightning Design System (SLDS)",
    "question": "A UX Designer needs to customize the visual appearance of an Experience Cloud site to match corporate branding guidelines. Which three branding elements can be configured declaratively in Experience Builder? (Choose 3 answers)",
    "choices": [
      "Color Palette",
      "Font Family",
      "Company Logo",
    ...
    "explanation": "Experience Builder branding panel allows declarative customization of colors, typography, and site logo without writing code."
  },
  {
    "id": 141,
    "category": "Testing",
  ...
  },
  {
    "id": 204,
    "category": "Testing",
    "question": "Which metric tracks the percentage of users who complete a specific task or workflow successfully during usability testing?",
    "choices": [
      "Task Completion Rate (Task Success Rate)",
      "Page Bounce Rate",
      "Click-Through Rate",
      "System CPU Utilization"
    ],
    "correctAnswerText": "Task Completion Rate (Task Success Rate)",
    "explanation": "Task Completion Rate measures the proportion of participants who successfully complete a designated usability task."
  },
  {
    "id": 205,
    "category": "Discovery",
    "question": "Which workshop technique brings cross-functional stakeholders together to map out end-to-end user actions, touchpoints, emotion levels, and pain points across a service lifecycle?",
    "choices": [
    ...
    "correctAnswerText": "Customer Journey Mapping",
    "explanation": "Customer Journey Mapping visualizes the complete user experience over time across channels, identifying pain points and opportunities."
  },
  {
    "id": 206,
    "category": "Salesforce Lightning Design System (SLDS)",
...
/**
 * Validates selected answer options against the correctAnswerText.
 * Uses exact array set matching (selectedChoices.sort() === correctAnswerText.sort()).
 */
function isAnswerCorrect(q, userSelection) {
  ...
  if (Array.isArray(q.correctAnswerText)) {
    if (userArr.length !== q.correctAnswerText.length) return false;
    const targetNorm = q.correctAnswerText.map(cleanText).sort();
    const userNorm = userArr.map(cleanText).sort();
    return targetNorm.every((val, idx) => val === userNorm[idx]);
  } else {
    const singleUserStr = cleanText(userArr[0] || "");
...
function renderTabButtons() {
  ...
  const tabs = [
    ...
    { label: "Full Exam Simulator (210)", icon: "🎯" }
  ];
    ...
    <div class="dashboard-grid">
      <div class="dash-card">
        ...
        <p style="font-size:.8rem;color:var(--text-muted);margin-top:12px">
          Multiple-choice format across 6 official domains. This simulator contains exactly ${totalQuestions} practice questions with multi-select support and real-time score tracking.
        </p>
      </div>
...
// ============================================================
// SECTION 7: QUIZ RENDERING & MULTI-SELECT ADAPTATION
// ============================================================
 ...
 * Dynamic Option Lengths: Supports 3, 4, 5, 6+ options cleanly.
 * Multi-Select Adaptation: If correctAnswerText contains multiple items, render HTML checkboxes.
 */
function renderQuestionCard(q) {
  ...
  const isMultiSelect = Array.isArray(q.correctAnswerText) && q.correctAnswerText.length > 1;
